...
[![crates.io](https://img.shields.io/crates/v/rusty_rtos_alloc.svg)](https://crates.io/crates/rusty_rtos_alloc)
[![docs.rs](https://docs.rs/rusty_rtos_alloc/badge.svg)](https://docs.rs/rusty_rtos_alloc)
[![license](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue.svg)](#license)

The Kairos **allocator seam**: [`rusty_alloc`](https://github.com/Remade-With-Rust/rusty_alloc)
— a pure-Rust mimalloc remake, pinned exactly — as the global allocator of a
hosted deliverable. The seam hands out the type; the deliverable's `main.rs`
declares it. **No library in the family ever declares a global allocator**, so
an application is never handed one it did not ask for.
...
`riscv32imafc-unknown-none-elf` by CI and `kairos check`.

**Known gaps.** Nothing here has run on a board yet — that is K4's ledger row.
...
MIT OR Apache-2.0, at your option. This crate is a seam over
[`rusty_alloc`](https://github.com/Remade-With-Rust/rusty_alloc) and links no
FreeRTOS code.
